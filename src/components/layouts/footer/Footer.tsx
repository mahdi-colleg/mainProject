        ...
        <footer className="container mb-[68px] relative">
            ...
            <div onClick={()=>setShowModal(true)} className="mb-[68px]">
                <div
                    ...
                    <ImageView src="/assets/images/Screenshot (76).png" className="absolute bottom-0 right-0 sm:h-full w-auto" alt={"banner"} width={587} height={331}/>
            ...
            <div
                ...
                <div className="pt-4 md:pt-0">
                    <div
                        className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Information
                        <IconBox icon={"icon-down-dark inline-block sm:hidden"} size={24}/>
                    </div>
                    <ul className="hidden md:flex flex-col gap-2.5">
